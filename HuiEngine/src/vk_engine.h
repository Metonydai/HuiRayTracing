...
private:
    ...
    void mainLoop() {
        while (!glfwWindowShouldClose(window)) {
            ...
            ImGui::DragFloat("pointSize", &pushConstants.diameter, 1.0f, 0.0f, 1000.0f);
            ...
            if (ImGui::Button("Adjust particles"))
            {
                ...
                for (auto& particle : particles) {
                    particle.position = adjustPosition;
                    particle.velocity = adjustVelocity;
                    particle.color = adjustColor;
                }
            ...
            if (ImGui::Button("Reset"))
            {
                ...
                adjustPosition = initialPosition;
                adjustVelocity = initialVelocity;
                adjustColor = initialColor;
